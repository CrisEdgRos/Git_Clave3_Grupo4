    ...
    public class D_MovimientoTarjeta
    {
        ...
        public string GuardarMV_tarjeta(int nOpcion, E_MovimientoTarjeta oCl)
        {
            ...
            try
            {
                ...
                MySqlParameter param2 = new MySqlParameter("@nID_MV_TARJETA", MySqlDbType.Int32) { Value = oCl.ID_MV_TARJETA };
                MySqlParameter param3 = new MySqlParameter("@nID_TARJETA_CREDITO", MySqlDbType.Int32) { Value = oCl.ID_TARJETA_CREDITO };
                ...
                MySqlParameter param6 = new MySqlParameter("@cID_SUCURSAL", MySqlDbType.Decimal) { Value = oCl.ID_SUCURSAL };
