    ...
    public class D_MovimientoAbono
    {
        ...
        public string GuardarMV_abono(int nOpcion, E_MovimientoAbono oCl)
        {
            ...
            try
            {
                ...
                MySqlParameter param2 = new MySqlParameter("@nID_MV_ABONO", MySqlDbType.Int32) { Value = oCl.ID_MV_ABONO };
                ...
                MySqlParameter param7 = new MySqlParameter("@cID_SUCURSAL", MySqlDbType.Decimal) { Value = oCl.ID_SUCURSAL };
