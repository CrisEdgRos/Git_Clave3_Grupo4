    ...
    public class D_MovimientoCuenta
    {
        ...
        public string GuardarMV_cuenta(int nOpcion, E_MovimientoCuenta oCl)
        {
            ...
            try
            {
                ...
                MySqlParameter param2 = new MySqlParameter("@nID_MV_CUENTA", MySqlDbType.Int32) { Value = oCl.ID_MV_CUENTA };
                MySqlParameter param3 = new MySqlParameter("@nID_CUENTA", MySqlDbType.Int32) { Value = oCl.ID_CUENTA };
